...
import (
	...
	"github.com/odisme0804/story-geth/crypto/signify"
	"github.com/odisme0804/story-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/odisme0804/story-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/odisme0804/story-geth/internal/version.gitDate="+env.Date)
	}
